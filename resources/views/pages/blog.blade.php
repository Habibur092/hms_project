        ...
        <section class="banner_area blog_banner d_flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <a href="#" class="btn white_btn button_hover">View More</a><br><br>
                    <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="{{asset('frontend/image/blog/cat-post/cat-post-3.jpg')}}" alt="post">
                    ...
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="{{asset('frontend/image/blog/cat-post/cat-post-2.jpg')}}" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                    ...
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="{{asset('frontend/image/blog/cat-post/cat-post-1.jpg')}}" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                        ...
                        <div class="blog_left_sidebar">
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="{{asset('frontend/image/blog/main-blog/m-blog-1.jpg')}}" alt="">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="{{asset('frontend/image/blog/main-blog/m-blog-2.jpg')}}" alt="">
                                        <div class="blog_details">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="{{asset('frontend/image/blog/main-blog/m-blog-3.jpg')}}" alt="">
                                        <div class="blog_details">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="{{asset('frontend/image/blog/main-blog/m-blog-4.jpg')}}" alt="">
                                        <div class="blog_details">
                            ...
                            <article class="row blog_item">
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        <img src="{{asset('frontend/image/blog/main-blog/m-blog-5.jpg')}}" alt="">
                                        <div class="blog_details">
