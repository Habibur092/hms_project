                ...
                <div class="row imageGallery1" id="gallery">
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/01.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/01.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/02.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/02.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/03.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/03.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/04.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/04.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/06.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/05.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/05.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/06.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/01-1.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/01-1.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/02-1.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/02-1.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 gallery_item">
                        <div class="gallery_img">
                            <img src="{{asset('frontend/image/gallery/03-1.jpg')}}" alt="">
                            <div class="hover">
                                <a class="light" href="{{asset('frontend/image/gallery/03-1.jpg')}}"><i class="fa fa-expand"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
