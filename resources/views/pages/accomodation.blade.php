                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="{{url('/accomodation')}}">Accomodation</a></li>
                ...
                <div class="row mb_30">
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="{{asset('frontend/image/room1.jpg')}}" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="{{asset('frontend/image/room2.jpg')}}" alt="">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="{{asset('frontend/image/room3.jpg')}}" alt="">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="{{asset('frontend/image/room4.jpg')}}" alt="">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
